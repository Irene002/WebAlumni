    ...
    return (
        <>
            <nav className="bg-orange-500 text-white p-8 px-4 sm:px-4 md:px-8 lg:px-12 xl:px-24" onContextMenu={(e) => e.preventDefault()}>
                <ul className="flex justify-center items-center md:justify-between lg:justify-between xl:justify-between">
                    ...
                    <li className="flex-row gap-8 hidden sm:hidden md:flex lg:flex xl:flex">
